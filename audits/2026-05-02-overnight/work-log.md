...
- [PR #22](https://github.com/baasvis/Sering-food-planner/pull/22) **S2** — stored XSS via id field on Batch/Catering/TransportItem/Recipe. Added `VALID_ID_PATTERN` regex to all validators + ingredient POST routes. 13 new tests, all 5 vectors verified rejected end-to-end.
