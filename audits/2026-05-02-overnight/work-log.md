...
- [PR #24](https://github.com/baasvis/Sering-food-planner/pull/24) **A10/T7** — dbReadAll error swallowing. Removed try/catch, errors now surface as 500 + frontend showDataError banner. Regression test added.
