...
- [PR pending] **U1+U3+U4** — ARIA quick wins. aria-live on toast + save indicator, role="dialog" + focus shift on modal, dropped maximum-scale viewport. Verified live in preview.
