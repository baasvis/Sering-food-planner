...
- Google Sheets as database, Google Sign-In for auth
- Hosted on Railway (auto-deploy from main branch)
...
lib/
  ...
  sheets.js            — Google Sheets client, read/write helpers, row converters, validation, write lock
routes/
...
- `scheduleSave()` debounces auto-save to Google Sheets
...
- Don't change Google Sheets data format without updating row converters in lib/sheets.js
