...
function tutNext() { _tutStep++; _tutAdvance(); }
function tutPrev() { _tutStep = Math.max(0, _tutStep - 1); _tutAdvance(); }
function tutSkip() { _tutTeardown(); }
...
function _tutRender(el, step, current, total) {
  const pad  = 10;
