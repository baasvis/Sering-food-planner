...
Object.assign(window, {
  ...
  // planner
  renderWeekPlan, setPlannerSubTab, renderPlannerSubTab, rerenderCurrentView, changePlannerDay, renderLocationPlan, getPoolBatches, toggleTypeBatchPool, renderTypeBatchPool, toggleShowAllBatches, renderShowAllBatches, batchDragStart, batchDragEnd, slotDragOver, slotDragLeave, slotDrop, startAssignMode, cancelAssignMode, assignBatchToSlot, renderTransportView, addTransportItem, deliverTransportItem, markSelectedArrived, removeDishFromSlot, toggleTypeCollapse, copyDayToOther, copySlotToOther, openAddDishTyped, openAddDish, renderAddModal, updateAddModal, switchAddModalTab, switchAddModalLoc, searchAddModal, confirmAddDish, addRecipeToSlot, addPlaceholderDish, openReplaceBatch, renderReplaceModal, switchReplaceTab, searchReplaceModal, confirmReplaceBatch, replaceWithRecipe, getInventoryState, getInventoryButton, openInventory, updateInventoryStock, cycleInventoryStorage, openServedFromInventory, finishInventory,
  ...
  // recipes
  renderRecipeIndex, updateRecipeResults, updateRiSearch, riSortBy, openAddRecipe, setRiMode, extractSheetId, fetchAndAddRecipe, bulkAddRecipes, openEditRecipe, saveEditRecipe, deleteRecipeIndex, addDishFromRecipe, addDishFromV2Recipe, deleteV2Recipe, recalcAllCosts, importCookedAmounts,

  // recipe editor
  openRecipeEditor, openRecipeDetail, reUpdateField, rePhotoSelected, reRemovePhoto, reAddIngredient, reRemoveIngredient, reMoveIngredient, reToggleFlexible, reUpdateIngredient, reIngredientSearch, reSelectIngredient, reHideSuggestions, reAddPrepStep, reRemovePrepStep, reMovePrepStep, reUpdatePrepStep, rePrepGhostFocus, reAddExtraAllergen, reRemoveExtraAllergen, reSaveRecipe, rePrintRecipe, reVersionRecipe, openBatchRecipe, openResolveFlexible, openPostCookRecording, brToggleFullscreen, brUpdateTargetLiters, brUpdateTargetPortions, detailUpdateLiters, detailUpdatePortions, detailResetScale, brIngSearch, brPickIng, brUnresolve, brUpdateAmount, brRemoveIng, brRestoreIng, brAddIngSearch, brAddIng, brUpdateNotes, brToggleDeduct, brClose, brSave,
