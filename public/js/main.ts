...
Object.assign(window, {
  ...
  // guests
  renderGuests, changeGuestDay, getGuestForDay, renderUploadSection, setupUploadHandlers, handleFiles, saveUploadedHistory, applyPredictions, updateGuests, updateGuestsNextWeek, setServiceClosure, restoreFocusAfterRender, discardPendingUpload,

  // planner
  renderWeekPlan, setPlannerSubTab, renderPlannerSubTab, rerenderCurrentView, changePlannerDay, renderLocationPlan, getPoolBatches, toggleTypeBatchPool, renderTypeBatchPool, toggleShowAllBatches, renderShowAllBatches, batchDragStart, batchDragEnd, slotDragOver, slotDragLeave, slotDrop, assignFamilyToSlot, renderTransportView, addTransportItem, deliverTransportItem, markSelectedArrived, markShipmentArrived, cancelShipment, removeDishFromSlot, removeFamilyFromSlot, toggleServicePin, toggleTypeCollapse, copyDayToOther, copySlotToOther, openAddDishTyped, openAddDish, renderAddModal, updateAddModal, switchAddModalTab, switchAddModalLoc, searchAddModal, confirmAddDish, addRecipeToSlot, addPlaceholderDish, openReplaceBatch, renderReplaceModal, switchReplaceTab, searchReplaceModal, confirmReplaceBatch, replaceWithRecipe, replaceWithV2Recipe, getInventoryState, getInventoryButton, openInventory, setInvMode, updateLocScopedQty, cycleInventoryStorageAt, cycleEntryStorageAt, updatePowerEntryQty, updateInventoryStock, cycleInventoryStorage, openServedFromInventory, finishInventory, updateSupplyInvCount, confirmPlannedCookedAt, updateCookConfirmQty,
  ...
  // supplies
  renderSupplies, suppliesSetSearch, suppliesToggleArchived, suppliesOpenNewKindPicker, suppliesOpenNew, suppliesOpenEdit, suppliesSave, suppliesDelete, suppliesOpenLogPrep, suppliesSubmitPrep, suppliesUpdateRecipeHint, suppliesUseCostEstimate,

  // recipes
  renderRecipeIndex, updateRecipeResults, updateRiSearch, setRiTypeFilter, riSortBy, openAddRecipe, setRiMode, extractSheetId, fetchAndAddRecipe, bulkAddRecipes, openEditRecipe, saveEditRecipe, deleteRecipeIndex, addDishFromRecipe, addDishFromV2Recipe, deleteV2Recipe,
