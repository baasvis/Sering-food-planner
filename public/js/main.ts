...
import { renderGuests, changeGuestDay, getGuestForDay, renderUploadSection, setupUploadHandlers, handleFiles, saveUploadedHistory, applyPredictions, updateGuests, updateGuestsNextWeek, setServiceClosure, restoreFocusAfterRender, sumCatDays, formatDateShort, _pendingUpload, _guestsDayOffset } from './guests';
...
Object.assign(window, {
  ...
  // guests
  renderGuests, changeGuestDay, getGuestForDay, renderUploadSection, setupUploadHandlers, handleFiles, saveUploadedHistory, applyPredictions, updateGuests, updateGuestsNextWeek, setServiceClosure, restoreFocusAfterRender,
