...
import { openRecipeEditor, openRecipeDetail, recipeEditorStep, reUpdateField, rePhotoSelected, reRemovePhoto, reAddIngredient, reRemoveIngredient, reMoveIngredient, reToggleFlexible, reUpdateIngredient, reIngredientSearch, reSelectIngredient, reHideSuggestions, reAddPrepStep, reRemovePrepStep, reMovePrepStep, reUpdatePrepStep, reAddExtraAllergen, reRemoveExtraAllergen, reSaveRecipe, rePrintRecipe, reVersionRecipe, openPostCookRecording, rePostCookSearch, rePostCookResolve, rePostCookUpdateAmount, rePostCookNotes, rePostCookDeduct, rePostCookSkip, rePostCookSave } from './recipe-editor';
...
Object.assign(window, {
  ...
  // recipe editor
  openRecipeEditor, openRecipeDetail, recipeEditorStep, reUpdateField, rePhotoSelected, reRemovePhoto, reAddIngredient, reRemoveIngredient, reMoveIngredient, reToggleFlexible, reUpdateIngredient, reIngredientSearch, reSelectIngredient, reHideSuggestions, reAddPrepStep, reRemovePrepStep, reMovePrepStep, reUpdatePrepStep, reAddExtraAllergen, reRemoveExtraAllergen, reSaveRecipe, rePrintRecipe, reVersionRecipe, openPostCookRecording, rePostCookSearch, rePostCookResolve, rePostCookUpdateAmount, rePostCookNotes, rePostCookDeduct, rePostCookSkip, rePostCookSave,
