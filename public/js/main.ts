...
import { isBatchCooked, getAmsterdamNow, dateToDayName, dateToIso, isServicePast, rebuildPlanner, renderDishListSplit, sortByCookDate, getGuests, calcRequired, calcRequiredBreakdown, calcTotalGuests, calcIngredientsFromRecipe, diffStr, storageBadge, storageBadgeClass, openServedDialog, openServedDialogForLoc, confirmArchiveWholeBatch, pendingRatings, ratingButtons, setRating, archiveDish, typeBadge, typeBadgeClass, TYPES, cycleType, toggleOrder, chipClass, getToday, dateToStr, strToDate } from './core';
...
import { renderCompetencies, openCompLogModal, selectCompTeacher, submitCompLog, openCompAddPerson, submitCompAddPerson, setCompStationFilter, openCompPerson, compBackToGrid, openCompChunk } from './competencies';
...
Object.assign(window, {
  ...
  // competencies
  renderCompetencies, openCompLogModal, selectCompTeacher, submitCompLog, openCompAddPerson, submitCompAddPerson, setCompStationFilter, openCompPerson, compBackToGrid, openCompChunk,
});
